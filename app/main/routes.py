from flask import render_template, current_app, redirect, url_for, request, g, jsonify, flash
...
from app.translate import translate, detected_language
...
@login_required
def messages():
    current_user.last_message_reat_time = datetime.utcnow()
